...
def main():
    ...
    st.set_page_config(page_title="Demostración de EMERGIA",
    ...
    st.sidebar.markdown(
        '<div style="text-align: center; font-size: 20px; font-weight: bold; color: gray; margin-bottom: 15px;">'
    ...
    st.markdown(
        ...
        <div style="display: flex; justify-content: center;">
            <a href="https://www.linkedin.com/company/belcorpcorporativo/?originalSubdomain=co" style="color: #0077B5; margin: 0 30px;"> 
                <i class="fab fa-linkedin" style="font-size: 30px;"></i>
            </a>
            <a href="https://www.instagram.com/belcorpcorporativo/?hl=es" style="color: #E4405F; margin: 0 30px;">
                <i class="fab fa-instagram" style="font-size: 30px;"></i>
            </a>
            <a href="https://x.com/belcorpycl" style="color: #1DA1F2; margin: 0 30px;">
                <i class="fab fa-twitter" style="font-size: 30px;"></i>
            </a>
            <a href="https://www.facebook.com/@BelcorpCorporativo/?locale=es_LA" style="color: #1877F2; margin: 0 30px;"> 
                <i class="fab fa-facebook" style="font-size: 30px;"></i>
            </a>
            <a href="https://www.youtube.com/user/somosbelcorp" style="color: #FF0000; margin: 0 30px;">
...
# -----------------------------------------------------
                ...
                configuraciones = [
                    {
                        ...
                        'order_f': [
                            'Máscara de pestañas Mega Full Size ',
                ...
                dona_plotly(df_prob_prod=df_prob_prod, producto='ILUMINACION',
                            titulo='Perfume Iluminas', col=col1_container2)
                    ...
                    configuraciones = [
                        {
                            ...
                            'order_f': ['Delineador líquido COLORFIX', 'Máscara de pestañas Mega Full Size ', 'Labial COLORFIX Duo', 'Labial COLORFIX Duo', 'Perfume Iluminas', 'No comprador']
                        }]
                    ...
                    configuraciones = [
                        {
                            ...
                            'order_f': ['Sin catalogar', 'Delineador líquido COLORFIX', 'Máscara de pestañas Mega Full Size ', 'Labial COLORFIX Duo', 'Perfume Vibranza ', 'Perfume Iluminas']
